  ...
  return (
    ...
    >
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <Card className="border-2 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
        ...
        >
          <Card className="border-2 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-br from-amber-50 to-transparent opacity-50 group-hover:opacity-70 transition-opacity" />
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative">
